...
AFS_PATH=${AFS_PATH-/afs/cs.cmu.edu/academic/class/15410-f08/Web/update/proj2}
WEB_URL=${WEB_URL-'http://www.acm.jhu.edu/~nwf/cs438/p2/update'}
...
case $1 in
	...
	;;
    *)
	echo usage: $0 'web|offline' '[query]'
	exit 9
	;;
esac
